...
import com.example.votingapp.arch.extensions.*
import com.example.votingapp.core.domain.error.ErrorMessage
import com.example.votingapp.core.sharedui.errorhandling.ViewError
import com.example.votingapp.core.sharedui.errorhandling.mapToViewError
...
// Fungsi untuk menyimpan nilai jika belum ada
fun <T : Any> setTagIfAbsent(key: String, value: T): T {
    @Suppress("UNCHECKED_CAST")
    return (tagMap[key] as? T) ?: run {
        tagMap[key] = value
        value
    }
}
